...
class LoginScreenEmailItem extends StatefulWidget {
  const LoginScreenEmailItem({super.key});

  @override
  State<LoginScreenEmailItem> createState() => _LoginScreenEmailItemState();
}

class _LoginScreenEmailItemState extends State<LoginScreenEmailItem> {
    ...
    return Form(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            build_field_name(LocaleKeys.auth_email.tr()),
